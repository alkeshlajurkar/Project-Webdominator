...
<ul>
	 ...
	 <li><a href="contact.jsp">Contact Us</a></li>
	  <li><a href="a#">Make Appointment</a></li>
...
<div class="container">
  <form action="contact_action.jsp">
   ...
   <input type="tel" id="phone" name="phone" placeholder="Your Phone No.." maxlength="10">
   <select>
	<option value="volvo">Choose barber</option>
	<option value="saab">Balu</option>
	<option value="opel">Chandu</option>
	<option value="audi">Pandu</option>
	</select>
...
<p>187,Near Sambhaji Nagar Road,<br>Hendaj,Murtizapur-444607<br>8390956095<br>royalsalon@gmail.com</p>
</td>
<td>
<h3>Get In Touch</h3>
